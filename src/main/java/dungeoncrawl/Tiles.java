...
import dungeoncrawl.logic.Drawable;
...
public class Tiles {
    ...
    static {
        ...
        tileMap.put("trees", new Tile(0, 13));
        tileMap.put("treeTop", new Tile(1, 13));
        tileMap.put("wall", new Tile(1, 0));
        tileMap.put("bushes", new Tile(2, 13));
