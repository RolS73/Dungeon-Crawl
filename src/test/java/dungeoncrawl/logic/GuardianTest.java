...
import dungeoncrawl.logic.actors.monsters.Guardian;
...
public class GuardianTest {
    ...
    void attackAndMove() {
        ...
        player.move(1,0);
        Assertions.assertEquals(guardian.getHealth(), 19);
        guardian.monsterMove(-1,0);
        guardian.monsterMove(-1,0);
    ...
    void moveNotUpdatesCells() {
        ...
        Assertions.assertEquals(1, guardian.getX());
        Assertions.assertEquals(1, guardian.getY());
